...
<section class="cards-section">
    <div class="cards-container">
        <div class="card">
            <img src="../../IMG/account-icoon.png" alt="Model 1" class="card-img">
        ...
        <div class="card">
            <img src="../../IMG/camera-icoon.png" alt="Model 2" class="card-img">
        ...
        <div class="card">
            <img src="../../IMG/beveiliging-icoon.png" alt="Model 3" class="card-img">
...
<section class="long-cards-section">
    ...
    <div class="long-cards-container">
        <div class="long-card">
            <img src="../../IMG/vinkje.png" alt="Service 1" class="long-card-img">
        ...
        <div class="long-card">
            <img src="../../IMG/vinkje.png" alt="Service 2" class="long-card-img">
            <div class="long-card-text">
        ...
        <div class="long-card">
            <img src="../../IMG/vinkje.png" alt="Service 3" class="long-card-img">
            <div class="long-card-text">
        ...
        <div class="long-card">
            <img src="../../IMG/vinkje.png" alt="Service 4" class="long-card-img">
            <div class="long-card-text">
